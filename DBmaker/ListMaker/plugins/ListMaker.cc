// -*- C++ -*-
//
// Package:    DBmaker/ListMaker
// Class:      ListMaker
// 
/**\class ListMaker ListMaker.cc DBmaker/ListMaker/plugins/ListMaker.cc
...
class ListMaker : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit ListMaker(const edm::ParameterSet&);
      ~ListMaker();
...
//
ListMaker::ListMaker(const edm::ParameterSet& iConfig)
...
void
ListMaker::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void
ListMaker::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
