...
# with command line options: SingleMuPt100_cfi --conditions auto:run2_mc -n 10 --era Phase2 --eventcontent FEVTDEBUG -s GEN,SIM,DIGI:pdigi_valid,L1,DIGI2RAW --datatier GEN-SIM --beamspot Realistic50ns13TeVCollision --customise SLHCUpgradeSimulations/Configuration/combinedCustoms.cust_2023LReco --geometry Extended2023LReco --no_exec --fileout out_sim.root
